...
public class CreatePropertyRequest {
  ...
  /**
   * 요청 객체를 CreatePropertyCommand 로 변환하여 리턴합니다.
   */
  public CreatePropertyCommand toCreatePropertyCommand(long userId) {
    var informationCommand = CreatePropertyCommand
    ...
    return new CreatePropertyCommand(userId, informationCommand, addressCommand);
  }
}
